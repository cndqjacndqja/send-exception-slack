package com.beomwhale.sendexceptionslack.support;
...
public class ExceptionMessageGenerator {
    ...
    public static String generate(final ContentCachingRequestWrapper request, final String exceptionMessage) {
        try {
            ...
            return String.format(MESSAGE_FORMAT, method, requestURI, headers, params, body, exceptionMessage);
        } catch (Exception e) {
